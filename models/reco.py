...
from layers.backbones.reco_layer import RECOLSSFPN
# from layers.backbones.lss_fpn import LSSFPN as RECOLSSFPN
from layers.heads.reco_head import RECOHEAD
...
class RECO(nn.Module):
    ...
    def __init__(self, backbone_conf, head_conf, is_train_height=False):
        ...
        self.backbone = RECOLSSFPN(**backbone_conf)
        self.head = RECOHEAD(**head_conf)
